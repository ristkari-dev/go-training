...
proto: ## Regenerate protobuf/gRPC code (requires protoc + protoc-gen-go[-grpc])
	...
	@for p in \
	  ...
	  lessons/27-container/solutions/proto/logstats.proto \
	  lessons/28-observability/exercises/proto/logstats.proto \
	  lessons/28-observability/solutions/proto/logstats.proto \
	  lessons/29-capstone-final/exercises/proto/logstats.proto \
	  lessons/29-capstone-final/solutions/proto/logstats.proto; do \
	  echo "protoc $$p"; \
