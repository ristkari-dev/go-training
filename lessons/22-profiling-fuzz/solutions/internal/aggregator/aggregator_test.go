...
// TestWalkPool runs the same 9-sub-test suite against WalkPool via an
// adapter that closes over a fixed workers=4. This way all three Walk
// variants are tested identically.
...
// workers=1 (serial), workers=2, workers=8, and workers=0 (default →
// runtime.NumCPU()) all produce the same WalkResult.
