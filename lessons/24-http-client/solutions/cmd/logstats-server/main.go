// Package main is the lesson 24 logstats HTTP service (reference impl).
//
// Endpoints:
//
...
import (
	...
	"github.com/ristkari-dev/go-training/lessons/24-http-client/solutions/internal/logparse"
	"github.com/ristkari-dev/go-training/lessons/24-http-client/solutions/internal/logstats"
)
