...
func TestVersionStamping(t *testing.T) {
	const pkg = "github.com/ristkari-dev/go-training/lessons/29-capstone-final/solutions/cmd/logstatsd"
	const buildinfoPkg = "github.com/ristkari-dev/go-training/lessons/29-capstone-final/solutions/warmup/buildinfo"
