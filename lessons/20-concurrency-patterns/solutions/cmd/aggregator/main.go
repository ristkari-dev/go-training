// Package main is the lesson 20 aggregator CLI reference implementation.
//
// Extends L19's main.go with -mode=pool + -workers=N flags.
package main
...
import (
	...
	"github.com/ristkari-dev/go-training/lessons/20-concurrency-patterns/solutions/internal/aggregator"
)
